...
>>>>>>> 280ad2cca5e3de8c070d4a7a70d40a91796acbf9
...
<<<<<<< HEAD
      <div className="flex justify-around p-7">
        <div className="w-1/5 text-center bg-primary font-titalium p-8">
          ...
          to enable them to reach and expand their potential, and to prepare
          them to become productive, responsible, ethical, creative and
        ...
        <div className="w-1/5 text-center bg-primary font-titalium  p-8">
          ...
          ex, dictum eu pretium vel, ullamcorper quis augue. In hac habitasse
          platea dictumst.
        </div>
        <div className="w-1/5 text-center bg-primary font-titalium  p-8">
          <h3 className="font-poppins font-semibold uppercase text-center">
